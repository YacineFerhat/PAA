...
const EcoTourisme = () => {
  const rows = useFetchEcoTourisme();
  const columns = [
    ...
    {
      field: "connaissanceEco",
      headerName: "Connaissance de l'Eco",
      width: 200,
    },
    { field: "pratiqueEco", headerName: "Pratique de l'Eco", width: 200 },
    { field: "tourismeEco", headerName: "Définition", width: 750 },
    { field: "importanceEco", headerName: "Importance", width: 750 },
  ];
  ...
  return (
    <section className={classes.root}>
      <div className={classes.titleContainer}>
        ...
        <div className={classes.title}> Eco-Tourisme :</div>
      </div>
